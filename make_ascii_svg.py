...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" font-family="monospace" '
             f'text-anchor="middle">fdjri@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13" font-family="monospace">'
             f'fdjri@github:~$ whoami <tspan fill="{INK}">Fdjri</tspan></text>')
