...
def emit(frames, mode, out, dur, reveal):
    ...
    p.append(f'<text x="{canvas_w/2:.0f}" y="{TITLEBAR_H/2 + 4:.0f}" fill="{TITLE_TEXT}" font-family="monospace" '
             f'font-size="11.5" text-anchor="middle">fdjri@github: ~$ ./wordmark.sh --3d</text>')
