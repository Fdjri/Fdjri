...
# 💻 Tech Stack & Tools:
[![My Skills](https://skillicons.dev/icons?i=html,css,php,java,cpp,js,ts,dart,flutter,laravel,nextjs,react,alpinejs,tailwindcss,bootstrap,mysql,vscode,git,postman,figma&theme=dark&perline=10)](https://skillicons.dev)
